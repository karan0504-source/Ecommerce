    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('brands.index') }}" class="btn btn-outline-dark">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <div class="card-body">								
                ...
                <div class="row">
                    ...
                    @if (!empty($brands->image))
                        <div>
                            <img width="250" src="{{ asset('uploads/brand/thumbs/'.$brands->image) }}">
                        </div>
                ...
                success: function(response){
					...
					if (response['status']==true){
                        ...
                        if(response['notFound']==true){
							windows.location.href="{{ route('brands.index') }}";
						}
