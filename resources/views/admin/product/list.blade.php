    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('products.create')}}" class="btn btn-outline-dark">New Product</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title">
                    <a href="{{ route('products.index') }}" class="btn btn-outline-dark">Reset</a>                
                </div>
                        ...
                        @if($products->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <img src="{{asset('admin-assets/img/avatar5.png')}}" class="img-thumbnail" width="50" >
                                    @endif
                                </td>
