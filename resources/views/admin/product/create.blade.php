                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="direction" id="direction" cols="30" rows="10" class="summernote" placeholder="Direction"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="benefits">Benefits</label>
                                    <textarea name="benefits" id="benefits" cols="30" rows="10" class="summernote" placeholder="Benefits"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="ingredients">Ingredients</label>
                                    <textarea name="ingredients" id="ingredients" cols="30" rows="10" class="summernote" placeholder="Ingredients"></textarea>
                                </div>
                            </div>  
                        </div>
                    </div>	                                                                      
...
@section('customJs')
    <script>
        ...
        function deleteImage(id){
            ...
            var url = '{{ route("temp-images.delete","ID") }}';
