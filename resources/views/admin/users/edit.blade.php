                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="password" minlength="8" name="password" id="password" class="form-control" placeholder="Password">	
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input value="{{$user->phone}}" type="tel" name="phone" id="phone" class="form-control" placeholder="Phone">	
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
