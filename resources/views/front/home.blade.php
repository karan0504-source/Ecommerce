...
@section('content')
@php
    $slugCategory = ''; // Initialize $categoryslug variable
@endphp
...
<div class="bg-white">
    ...
    <div class="container">
        <div class="section-title">
            <h2 class="bg-white">Featured Products</h2>
        </div>    
        <div class="row pb-3">
            @if ($featuredProducts->isNotEmpty())
                ...
                @else
                    @php
                        $slugCategory = 'featured-products';
                    @endphp
                @endif
                @php
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{ url('/Categories/'.$slugCategory.'/product/'.$product->slug) }}" class="product-img">
                        ...
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="{{ url('/Categories/'.$slugCategory.'/product/'.$product->slug) }}">{{ $product->title }}</a>
                            <div class="price mt-2">
                                <span class="h6"><strong>&#x20B9;&nbsp;{{ $product->price }}</strong></span>
...
<section class="section-4 pt-5">
    <div class="container">
        <div class="section-title">
            <h2 class="bg-white">Latest Products</h2>
        </div>    
        <div class="row pb-3">
